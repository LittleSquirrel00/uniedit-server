...
type PlanEntity struct {
	...
	Type          domain.PlanType     `gorm:"not null"`
...
func (e *PlanEntity) ToDomain() *domain.Plan {
...
type SubscriptionEntity struct {
	...
	Status               domain.SubscriptionStatus `gorm:"not null;default:active"`
...
func (e *SubscriptionEntity) ToDomain() *domain.Subscription {
...
func FromDomainSubscription(s *domain.Subscription) *SubscriptionEntity {
...
func (e *UsageRecordEntity) ToDomain() *domain.UsageRecord {
	return domain.RestoreUsageRecord(
		e.ID,
		e.UserID,
		e.APIKeyID,
		e.Timestamp,
...
func FromDomainUsageRecord(r *domain.UsageRecord) *UsageRecordEntity {
