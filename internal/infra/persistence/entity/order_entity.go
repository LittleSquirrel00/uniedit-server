...
func (e *OrderEntity) ToDomain() *order.Order {
	items := make([]*order.OrderItem, len(e.Items))
...
// FromDomainOrder creates an OrderEntity from a domain Order.
func FromDomainOrder(o *order.Order) *OrderEntity {
...
func (e *OrderItemEntity) ToDomain() *order.OrderItem {
	return order.RestoreOrderItem(
		e.ID,
		e.OrderID,
		e.Description,
		e.Quantity,
...
func OrderItemFromDomain(item *order.OrderItem) *OrderItemEntity {
...
// ToDomain converts the entity to a domain Invoice.
func (e *InvoiceEntity) ToDomain() *order.Invoice {
	return order.RestoreInvoice(
		e.ID,
		e.OrderID,
		e.UserID,
		e.InvoiceNo,
...
// FromDomainInvoice creates an InvoiceEntity from a domain Invoice.
func FromDomainInvoice(inv *order.Invoice) *InvoiceEntity {
