...
func (e *PaymentEntity) ToDomain() *payment.Payment {
	return payment.RestorePayment(
		e.ID,
		e.OrderID,
		e.UserID,
		e.Amount,
		e.Currency,
		payment.PaymentMethod(e.Method),
		payment.PaymentStatus(e.Status),
		e.Provider,
...
func FromDomainPayment(p *payment.Payment) *PaymentEntity {
...
func (e *StripeWebhookEventEntity) ToDomain() *payment.StripeWebhookEvent {
	return payment.RestoreStripeWebhookEvent(
		e.ID,
		e.EventID,
		e.Type,
		e.Data,
...
func FromDomainStripeWebhookEvent(e *payment.StripeWebhookEvent) *StripeWebhookEventEntity {
...
func (e *PaymentWebhookEventEntity) ToDomain() *payment.PaymentWebhookEvent {
	return payment.RestorePaymentWebhookEvent(
		e.ID,
		e.Provider,
		e.EventID,
		e.EventType,
...
func FromDomainPaymentWebhookEvent(e *payment.PaymentWebhookEvent) *PaymentWebhookEventEntity {
